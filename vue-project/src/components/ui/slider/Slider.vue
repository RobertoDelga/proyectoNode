...
<template>
  <SliderRoot
    ...
    v-bind="forwarded"
  >
    <SliderTrack class="relative h-2 w-full data-[orientation=vertical]:w-2 grow overflow-hidden rounded-full bg-slate-100 dark:bg-slate-800">
      <SliderRange class="absolute h-full data-[orientation=vertical]:w-full bg-slate-900 dark:bg-slate-50" />
    </SliderTrack>
    <SliderThumb
